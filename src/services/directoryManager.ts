...
export class DirectoryManager {
   ...
   */
  public getCompletedDirectory(): string {
   ...
   */
  public updateDownloadDirectory(newPath: string): void {
   ...
   */
  public validateDirectories(): { isValid: boolean; issues: string[] } {
    const issues: string[] = [];
   ...
   */
  public hasEnoughSpace(requiredBytes: number): boolean {
   ...
   */
  public getCompletedFiles(): string[] {
    try {
