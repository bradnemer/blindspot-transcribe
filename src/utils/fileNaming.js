...
export class FileNamingUtils {
     ...
     */
    static generateFilename(episode) {
     ...
     */
    static generateFilePath(episode, downloadDirectory) {
     ...
     */
    static generateTempFilename(episode) {
     ...
     */
    static generateTempFilePath(episode, downloadDirectory) {
     ...
     */
    static generateUniqueFilename(originalFilename, existingFiles) {
