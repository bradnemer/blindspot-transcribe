...
jest.mock('../CSVUpload', () => ({
    CSVUpload: ({ onFileValidated, onError }) => (_jsxs("div", { "data-testid": "csv-upload", children: [_jsx("button", { onClick: () => {
                    const mockEpisodes = [
                        {
                            id: 1,
                ...
                }, children: "Mock File Upload" }), _jsx("button", { onClick: () => onError('Mock error message'), children: "Mock Error" })] }))
}));
const defaultProps = {
...
describe('CSVUploadContainer', () => {
    ...
    it('renders upload interface by default', () => {
        render(_jsx(CSVUploadContainer, { ...defaultProps }));
    ...
    it('truncates long episode titles in preview', () => {
        ...
        const CSVUploadMock = ({ onFileValidated }) => (_jsx("div", { "data-testid": "csv-upload", children: _jsx("button", { onClick: () => onFileValidated(longTitleEpisode), children: "Mock Long Title Upload" }) }));
    ...
    it('shows "No URL" for episodes without audio URLs', () => {
        ...
        const CSVUploadMock = ({ onFileValidated }) => (_jsx("div", { "data-testid": "csv-upload", children: _jsx("button", { onClick: () => onFileValidated(noUrlEpisode), children: "Mock No URL Upload" }) }));
        jest.doMock('../CSVUpload', () => ({
            CSVUpload: CSVUploadMock
        }));
        render(_jsx(CSVUploadContainer, { ...defaultProps }));
    ...
    it('limits preview table to 10 episodes', () => {
        ...
        const CSVUploadMock = ({ onFileValidated }) => (_jsx("div", { "data-testid": "csv-upload", children: _jsx("button", { onClick: () => onFileValidated(manyEpisodes), children: "Mock Many Episodes Upload" }) }));
        jest.doMock('../CSVUpload', () => ({
            CSVUpload: CSVUploadMock
        }));
        render(_jsx(CSVUploadContainer, { ...defaultProps }));
    ...
    it('handles invalid dates gracefully', () => {
        ...
        const CSVUploadMock = ({ onFileValidated }) => (_jsx("div", { "data-testid": "csv-upload", children: _jsx("button", { onClick: () => onFileValidated(invalidDateEpisode), children: "Mock Invalid Date Upload" }) }));
        jest.doMock('../CSVUpload', () => ({
            CSVUpload: CSVUploadMock
        }));
        render(_jsx(CSVUploadContainer, { ...defaultProps }));
...
//# sourceMappingURL=CSVUploadContainer.test.js.map