...
describe('DownloadManager', () => {
    ...
    it('renders download manager header', () => {
        render(_jsx(DownloadManager, { ...defaultProps }));
    ...
    it('handles start queue button click', () => {
        ...
        expect(defaultProps.onError).toHaveBeenCalledWith('Download queue will be connected in next integration phase');
    });
    ...
    it('handles empty download queue', () => {
        ...
        const { rerender } = render(_jsx(DownloadManager, { ...defaultProps }));
...
//# sourceMappingURL=DownloadManager.test.js.map