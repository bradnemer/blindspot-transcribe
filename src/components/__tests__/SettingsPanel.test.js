...
describe('SettingsPanel', () => {
    ...
    it('renders settings panel header', () => {
        render(_jsx(SettingsPanel, { ...defaultProps }));
    ...
    it('saves settings to localStorage', async () => {
        ...
        await waitFor(() => {
            expect(localStorageMock.setItem).toHaveBeenCalledWith('podcast-manager-settings', expect.stringContaining('"auto_start":false'));
        });
    });
