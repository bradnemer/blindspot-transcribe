...
describe('EpisodeList', () => {
  ...
  it('calls onError when bulk download is attempted', () => {
    ...
    expect(defaultProps.onError).toHaveBeenCalledWith(
      'Download functionality will be connected in next phase'
    );
  });

  it('shows empty state when no episodes', () => {
    render(<EpisodeList {...defaultProps} episodes={[]} />);
  ...
  it('truncates long episode titles', () => {
    ...
    render(<EpisodeList {...defaultProps} episodes={[longTitleEpisode]} />);
  ...
  it('handles invalid dates gracefully', () => {
    ...
    render(<EpisodeList episodes={[invalidDateEpisode]} onRefresh={jest.fn()} onError={jest.fn()} />);
  ...
  it('truncates long episode descriptions', () => {
    const longDescriptionEpisode: Episode = {
      id: 6,
    ...
    render(<EpisodeList episodes={[longDescriptionEpisode]} onRefresh={jest.fn()} onError={jest.fn()} />);
